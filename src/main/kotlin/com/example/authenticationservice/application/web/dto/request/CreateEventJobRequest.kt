...
data class CreateEventJobRequest(
        ...
        @JsonProperty("jobs") @field:NotNull(message = "A lista de trabalhos não pode ser nula") val jobs: List<com.example.authenticationservice.application.web.controller.dto.request.JobRequest>?
)
