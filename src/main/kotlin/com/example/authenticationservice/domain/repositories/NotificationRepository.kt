...
import com.example.authenticationservice.application.web.controller.dto.response.DeleteNotificationDto
...
interface NotificationRepository: JpaRepository<Notification, Long> {
    ...
    """)
    fun findDeleteNotificationDtoByUserIdAndNotificationId(userId: Long, notificationId: Long, notificationType: NotificationTypeDto): com.example.authenticationservice.application.web.controller.dto.response.DeleteNotificationDto?
